      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-[#8DC63F] font-medium mb-4">
            Ready To Drive In 30 Seconds
          </p>

          <h3 className="text-2xl font-bold text-[#0C2340] mb-4">
            Green Glide Swapping Stations
          </h3>

          <p className="mb-4 text-gray-600">
            <span className="font-semibold text-[#0C2340]">
              Green Glide battery swapping stations
            </span>{" "}
            are equipped with powering machines capable of charging minimum 8-10
            batteries at a time. These stations facilitate riders to swap
            batteries within 60 seconds and get ready for a new ride
            immediately.
          </p>
          ...
          <p className="text-gray-600">
            ...
            can be installed at public places e.g. shopping malls, Schools,
            Universities, Multiplexes, Manufacturing Hubs etc.
          </p>
        </div>
      </div>
    </section>
